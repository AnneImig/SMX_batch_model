...
source_file = "control_log.pst"
destination_file = "control_log2.pst"
...
pst_file = "control_log.pst"  # Your PEST control file
par_file = "control_log.par"  # File with the calibrated parameters
pst_file_new = "control_log2.pst"  # File with the calibrated parameters
