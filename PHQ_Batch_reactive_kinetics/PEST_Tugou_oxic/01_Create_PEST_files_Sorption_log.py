...
bounds = {
    ...
    "K1":             {"lower": 1e-8,   "upper": 1e3},
    "K2":             {"lower": 1e-7,   "upper": 1},
    "K3":             {"lower": 1,      "upper": 9e10},

    # Nitrification
    "K4":             {"lower": 1e2,    "upper": 5e4},
    "K5":             {"lower": 1e3,    "upper": 9e8},

    # Denitrification
    "K6":             {"lower": 1e-3,   "upper": 1e4},
    "K7":             {"lower": 1,      "upper": 1e4},
    "K_NO3":          {"lower": 1e-7,   "upper": 9e-2},

    # SMX fate with TP formation and retransformation
    "K8":             {"lower": 1e-6,   "upper": 3},
    "K_DOC":          {"lower": 1.6e-11, "upper": 1},
    "K9":             {"lower": 1e1,    "upper": 1e32},
    "K10":            {"lower": 1e1,    "upper": 1e30},
    "K11":            {"lower": 1e-2,      "upper": 1e5},
    "K12":            {"lower": 1e1,     "upper": 1e10},
...
control_data += (
    '* model input/output\n'
    f'{os.path.basename(tpl_file)}'+ f' {os.path.basename(phrq_file)}\n'
